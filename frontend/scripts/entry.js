...
Vue.prototype.$OPENFOOTPRINT_GLOBAL = JSON.parse(
  document.getElementById("OPENFOOTPRINT_GLOBAL").textContent
);
Vue.prototype.$OPENFOOTPRINT_GLOBAL["transport_modes"].unshift({
  value: null,
  text: ""
});
