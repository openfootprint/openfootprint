...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mode', models.CharField(choices=[('guess', 'Guess'), ('plane', 'Plane'), ('car', 'Car'), ('train', 'Train'), ('truck', 'Truck'), ('bus', 'Bus'), ('foot', 'Foot')], max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='core.Address')),
                ('to_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='core.Address')),
                ('transport', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='core.Transport')),
            ],
        ),
        migrations.CreateModel(
            name='Report',
            fields=[
                ...
                ('footprint', models.BigIntegerField(blank=True, null=True, verbose_name='Footprint in gCO2e')),
                ('name', models.CharField(max_length=200, verbose_name='Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Person')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meals', to='core.Project')),
                ('tags', models.ManyToManyField(blank=True, to='core.Tag')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='core.Address')),
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Person')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotels', to='core.Project')),
                ('tags', models.ManyToManyField(blank=True, to='core.Tag')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='datapoints', to='core.Project')),
            ],
        ),
        migrations.CreateModel(
